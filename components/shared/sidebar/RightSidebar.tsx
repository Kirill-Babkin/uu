...
const RightSidebar = () => {
  return (
    <section className="background-light900_dark200 custom-scrollbar border-l dark:border-none shadow-light-300 dark:shadow-none overflow-y-auto flex flex-col h-screen w-full max-w-[350px] max-xl:hidden pt-28 p-6">
      <TopQuestions />
      <PopularTags />
    </section>
  );
